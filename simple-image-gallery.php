...
if ( !class_exists( 'DGImageGallery' ) ) {
    ...
    class DGImageGallery extends DGCustomPostType {
        ...
        public function render_meta_box_content( $post ) {
            ...
            <div class="dg-content">
                ...
                <div class="dg-row">
                    <div class="dg-col-md-4">Image Caption</div>
                    <div class="dg-col-md-4">Image Preview</div>
                    <div class="dg-col-md-4">Update/Remove</div>
                </div>
                <div class="dg-row dg-top-space">
                    <div class="dg-col-md-4"></div>
                    <div class="dg-col-md-4 dg-text-center">
                        <input type="button" class="add_new_image dg-btn dg-btn-success dg-btn-block" value="Add New Image">
                    </div>
                    <div class="dg-col-md-4"></div>
                </div>
                <div class="dg-row dg-top-space">
                    ...
                    if ( isset( $galleries['url'] ) && is_array( $galleries['url'] ) ) {
                        ...
                        foreach ( $galleries['url'] as $gallery ) {
                            ...
                            ?>
                                <div class="dg-col-md-4" style="padding-top: 60px">
                                    <input type="text" name="gallery_meta_url[]" class="gallery_meta_url wide dg-form-control" value="<?php echo $galleries['url'][$i]; ?>" style="display: none;">
                                    <input type="text" name="gallery_meta_caption[]" class="gallery_meta_caption wide dg-form-control" value="<?php echo $galleries['caption'][$i]; ?>">
                                </div>
                                <div class="dg-col-md-4" style="height: 150px; overflow: hidden;">
                                    <img src="<?php echo $image_attributes[0]; ?>" class="gallery_meta_img" style="display: block;" width="100%" style="border: 3px solid #dedede;">
                                </div>
                                <div class="dg-col-md-2 dg-text-right" style="padding-top: 60px">
                                    <input type="button" name="gallery_meta_upload" class="gallery_meta_upload wide dg-btn dg-btn-info dg-btn-block" value="Change" style="cursor: pointer; cursor: hand;">
                                </div>
                                <div class="dg-col-md-2 dg-text-right" style="padding-top: 60px">
                                    <input type="button" name="gallery_meta_remove" class="gallery_meta_remove dg-btn dg-btn-danger dg-btn-block" value="Remove" style="cursor: pointer; cursor: hand;">
                                </div>
                            <?php
                            $i++;
                        }
                        ...
                        ?>
                            <div class="dg-col-md-4" style="padding-top: 60px">
                                <input type="text" name="gallery_meta_url[]" class="gallery_meta_url wide dg-form-control" value="" style="display: none;">
                                <input type="text" name="gallery_meta_caption[]" class="gallery_meta_caption wide dg-form-control" value="">
                            </div>
                            <div class="dg-col-md-4" style="height: 150px; overflow: hidden;">
                                <img src="" class="gallery_meta_img" style="display: none; padding: 10px 10px 10px 0; border: none;" width="100%" style="border: 3px solid #dedede;">
                            </div>
                            <div class="dg-col-md-2 dg-text-right" style="padding-top: 60px">
                                <input type="button" name="gallery_meta_upload" class="gallery_meta_upload wide dg-btn dg-btn-danger dg-btn-block" value="Upload" style="cursor: pointer; cursor: hand;">
                            </div>
                            <div class="dg-col-md-2 dg-text-right" style="padding-top: 60px">
                                <input type="button" name="gallery_meta_remove" class="gallery_meta_remove dg-btn dg-btn-danger dg-btn-block" value="Remove" style="display: none; cursor: pointer; cursor: hand;">
                            </div>
                        <?php
                    }
                    ?>
